...
public class GroupMsgContent implements Serializable {
    ...
    public Boolean getTimedMessage() {
        return isTimedMessage;
    }

    public void setTimedMessage(Boolean timedMessage) {
        isTimedMessage = timedMessage;
    }
    ...
    public Date getSelfDestructTime() {
        return selfDestructTime;
    }

    public void setSelfDestructTime(Date selfDestructTime) {
