...
public interface GroupMsgContentService {
    ...
    void deleteGroupMsgContentByIds(List<Integer> ids);

    void deleteMessage(GroupMsgContent groupMsgContent);

    //void addSelfDestructMessage(GroupMsgContent groupMsgContent);
}